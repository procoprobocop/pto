...
DISKNAME=$(whiptail --title "Настройка сетевого диска" --inputbox "Введите hostname или ip-адрес сетевого диска организации (пример: ptosrv007 или 10.10.73.7) " 10 60 ptosrv007  3>&1 1>&2 2>&3)
exitstatus=$?
if [ $exitstatus = 0 ]; then
